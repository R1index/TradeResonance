...
STRINGS: Dict[str, Dict[str, str]] = {
    "en": {
        ...
        "best_deals_hint": "Top buy & sell right now",
        "best_buy_label": "Best buy",
        "best_sell_label": "Best sell",
        "route_buy": "Buy in",
        "route_sell": "Sell in",
        "spread": "Spread",
        "profit": "Profit",
    ...
    "ru": {
        ...
        "best_deals_hint": "Самые выгодные покупки и продажи сейчас",
        "best_buy_label": "Лучшая закупка",
        "best_sell_label": "Лучшая продажа",
