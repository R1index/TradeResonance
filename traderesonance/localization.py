...
STRINGS: Dict[str, Dict[str, str]] = {
    "en": {
        ...
        "best_route_empty_title": "No fresh routes",
        "best_route_empty_hint": "We couldn't find a producer-to-market route updated this hour.",
        "route_buy": "Buy in",
        "route_sell": "Sell in",
        "spread": "Spread",
        "profit": "Profit",
    ...
    "ru": {
        ...
        "best_route_empty_title": "Нет свежих маршрутов",
        "best_route_empty_hint": "За последний час не найдено маршрутов с производственного города.",
